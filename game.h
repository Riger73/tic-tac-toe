 ...
 *
 * Firstly you want to initialise the random number generator. Next
 * you want to initialise the game board to empty.  After this, you
 * 
 **/ 
 /* TN Assumption made that play_game takes two players and returns winner if identified and null otherwise*/
